...
@implementation SFNYTimesParser

#pragma mark - initialisation methods - 

+ (instancetype)initWithFeed:(NSURL *)url {
	return [[SFNYTimesParser alloc]initWithURL:url];
}
...
- (void)feedParserDidFinish:(MWFeedParser *)parser {
	[[NSNotificationCenter defaultCenter] postNotificationName:SFNetworkDidRetrieveNYTimesFeed object:self.feedsItemsArray];
}

- (void)feedParser:(MWFeedParser *)parser didFailWithError:(NSError *)error {
	[[NSNotificationCenter defaultCenter] postNotificationName:SFNetworkDidRetrieveNYTimesFeedError object:error];
